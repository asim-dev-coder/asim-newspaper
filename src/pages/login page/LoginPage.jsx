      ...
      <div class="relative py-3 sm:max-w-xl sm:mx-auto">
        ...
        >
          <div class="max-w-md mx-auto">
            <div class="text-lg">
              <span className='font-semibold'>ইতোমধ্যে একাউন্ট আছে ?</span> লগইন করুন
            </div>
            <div class="mt-5">
              <label
            ...
            <div class="mt-3">
              <button
                class="py-2 px-4 bg-rose-500 hover:bg-rose-600 focus:ring-rose-400 focus:ring-offset-rose-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg"
                type="submit"
              >
                লগইন করুন
              </button>
            </div>
            <div class="my-3 text-gray-600 text-center text-sm font-semibold" type="submit">অথবা</div>
            <div class="flex justify-center w-full items-center">
              <div>
                <button
                  class="flex items-center justify-center py-2 px-20 bg-white hover:bg-gray-200 focus:ring-rose-500 focus:ring-offset-rose-200 text-gray-700 w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg"
                >
                  <svg
                    viewBox="0 0 24 24"
                    height="25"
                ...
                <button
                  class="flex items-center justify-center py-2 px-20 bg-white hover:bg-gray-200 focus:ring-rose-500 focus:ring-offset-rose-200 text-gray-700 w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg mt-4"
                >
                  <svg
                    viewBox="0 0 30 30"
                    height="30"
            ...
            <div class="flex items-center justify-between mt-4">
              <span class="w-1/5 border-b dark:border-gray-600"></span>
              <Link to="/signup"
                class="text-sm text-gray-500 uppercase dark:text-gray-400 hover:underline"
                href="#"
              >কোন একাউন্ট নেই ? <span className='text-black'>সাইনআপ করুন</span>
              </Link>
