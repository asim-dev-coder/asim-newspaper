...
function LifeStyle({ categorieName }) {
            ...
            <div className='w-[260px] h-[190px] scroll-auto' key={index}>
              ...
              <div>
                ...
                <div className='flex items-center justify-between'>
                  ...
                  <Link to={`/lifeStyledetails/${course.id}`}><button className='btn rounded-xl px-2 outline-none  bg-white border-gray-400 text-gray-600 text-sm mt-4 hover:text-white hover:bg-rose-500 hover:border-none'>বিস্তারিত পড়ুন
                  </button></Link>
                </div>
              </div>
